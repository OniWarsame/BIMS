      ...
      <div style={{position:"fixed",top:22,left:20,zIndex:20,display:"flex",alignItems:"center",gap:10}}>
        ...
        <div>
          <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:14,fontWeight:800,
            ...
            Nexus<span style={{color:"hsl(270,100%,55%)",marginLeft:4}}>BIMS</span>
          </div>
      ...
      <div style={{textAlign:"center" as const,marginBottom:22}}>
        ...
        <motion.div
          ...
          style={{width:62,height:62,borderRadius:18,margin:"0 auto 14px",
            background:"linear-gradient(135deg,rgba(0,175,248,0.2),rgba(0,100,120,0.15))",
        ...
        <h1 style={{fontFamily:"'Orbitron',sans-serif",fontSize:22,fontWeight:800,
          letterSpacing:"0.1em",color:"rgba(210,235,255,0.98)",margin:"0 0 4px",
          textShadow:"0 0 30px rgba(55,155,255,0.3)"}}>
          BIMS
        </h1>
        <p style={{fontFamily:"'JetBrains Mono',monospace",fontSize:8.5,letterSpacing:"0.18em",
          color:"rgba(0,195,255,0.45)",margin:0,textTransform:"uppercase" as const}}>
            ...
            <AnimatePresence>
              {isError && (
                <motion.div initial={{opacity:0,y:6}} animate={{opacity:1,y:0}} exit={{opacity:0}}
                  ...
                  <p style={{fontFamily:"'Exo 2',sans-serif",fontSize:10.5,fontWeight:500,
            ...
            {isGrant ? (
              ...
              <motion.div initial={{opacity:0,y:8}} animate={{opacity:1,y:0}}
                ...
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:8}}>
                    <motion.div animate={{opacity:[1,0.3,1]}} transition={{duration:1,repeat:Infinity}}
                      style={{width:7,height:7,borderRadius:"50%",
                        background:"hsl(280,90%,62%)",boxShadow:"0 0 8px rgba(70,175,255,0.85)"}}/>
                  ...
                  <span style={{fontFamily:"'Orbitron',sans-serif",fontSize:14,fontWeight:800,
                ...
                <div style={{display:"flex",gap:14,padding:"14px"}}>
                  {matchRecord.photo
                    ...
                    : <div style={{width:70,height:70,borderRadius:10,
                        background:"rgba(40,120,240,0.1)",border:"1px solid rgba(0,195,255,0.3)",
                        display:"flex",alignItems:"center",justifyContent:"center",
