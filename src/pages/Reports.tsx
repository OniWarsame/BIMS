      ...
      <PageHeader
        ...
        rightContent={
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            ...
            <button onClick={exportLogs} style={{display:"flex",alignItems:"center",gap:6,fontFamily:"'Orbitron',monospace",fontSize:9,fontWeight:700,letterSpacing:"0.12em",padding:"7px 14px",borderRadius:9,border:"1.5px solid hsla(192,100%,55%,0.5)",background:"hsla(192,100%,52%,0.1)",color:"hsl(193,100%,72%)",cursor:"pointer",transition:"all .15s"}}
