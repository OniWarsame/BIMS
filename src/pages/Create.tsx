...
const CATEGORIES:Category[] = [
  { id:"cv", label:"Curriculum Vitae", icon:"📄", color:"#60a5fa", bg:"rgba(96,165,250,0.22)", border:"rgba(96,165,250,0.8)", desc:"Professional resume from your biometric profile",
    templates:[
      ...
      {id:"cv-modern",       name:"University Application CV",       desc:"Structured academic CV with photo panel — accepted by universities for MSc/PhD admissions.",         preview:"🎓"},
      {id:"cv-minimal",      name:"UN / International Org CV",       desc:"Clean typographic layout conforming to UN and international organisation standards.",                 preview:"🌐"},
      {id:"cv-technical",    name:"Professional Engineer CV",        desc:"Competency-matrix format for engineering councils, visa sponsors and technical recruiters.",           preview:"⚙️"},
      ...
      {id:"cv-executive",    name:"Senior Executive / C-Suite CV",   desc:"Board-level achievement CV with leadership summary — suitable for directorship applications.",      preview:"💼"},
      {id:"cv-europass",     name:"Europass Format",                 desc:"Official European CV format accepted across all EU member states for employment and education.",     preview:"🇪🇺"},
      {id:"cv-medical",      name:"Medical Professional CV",         desc:"Clinical experience, certifications and GMC/medical council format.",                                preview:"🏥"},
    ]},
  { id:"contract", label:"Official Contract", icon:"📜", color:"#fb923c", bg:"rgba(251,146,60,0.22)", border:"rgba(251,146,60,0.8)", desc:"Legally structured contract templates",
    templates:[
      {id:"contract-employment",  name:"Employment Contract",       desc:"Full employment agreement with probation, benefits and termination clauses.",   preview:"💼"},
      {id:"contract-service",     name:"Service Agreement",         desc:"Professional services with deliverables, milestones and payment schedule.",      preview:"🤝"},
      {id:"contract-nda",         name:"Non-Disclosure (NDA)",      desc:"Mutual or one-way confidentiality agreement — GDPR compliant.",                 preview:"🔒"},
      {id:"contract-freelance",   name:"Freelance Agreement",       desc:"Scope of work, IP ownership, rates and project delivery terms.",                 preview:"🖊️"},
      {id:"contract-partnership", name:"Partnership Agreement",     desc:"Joint venture profit sharing, decision-making and dissolution clauses.",          preview:"🤲"},
      {id:"contract-consulting",  name:"Consulting Agreement",      desc:"Advisory retainer, deliverables, non-compete and confidentiality.",              preview:"📊"},
    ]},
  { id:"birth", label:"Certificate of Birth", icon:"🏛️", color:"#a78bfa", bg:"rgba(167,139,250,0.22)", border:"rgba(167,139,250,0.8)", desc:"Official-style birth certificate",
    templates:[
      ...
      {id:"birth-modern",     name:"Modern Civil Registry",       desc:"Contemporary registry format with security watermark.",         preview:"📑"},
      {id:"birth-bilingual",  name:"Bilingual Arabic/English",    desc:"Dual-language international birth certificate.",                preview:"🌐"},
    ]},
  { id:"personal", label:"Personal Statement", icon:"✍️", color:"#34d399", bg:"rgba(52,211,153,0.22)", border:"rgba(52,211,153,0.8)", desc:"Compelling personal statements",
    templates:[
      {id:"ps-academic",    name:"University Admission",      desc:"Postgraduate/undergraduate SOP tailored to academic background.",  preview:"🎓"},
      {id:"ps-job",         name:"Job Application Cover",     desc:"Targeted cover letter using verified work history.",               preview:"👔"},
      {id:"ps-visa",        name:"Visa / Travel Statement",   desc:"Purpose-of-visit letter for embassy submission.",                   preview:"✈️"},
      {id:"ps-scholarship", name:"Scholarship Letter",        desc:"Financial aid SOP using education and achievements.",             preview:"🏆"},
      {id:"ps-immigration", name:"Immigration Statement",     desc:"Residency/citizenship SOP with biographical narrative.",           preview:"🌍"},
      {id:"ps-medical",     name:"Medical Referral Letter",   desc:"Patient statement and clinical history summary.",                  preview:"🏥"},
    ]},
  { id:"notary", label:"Notary & Legal", icon:"⚖️", color:"#fbbf24", bg:"rgba(251,191,36,0.22)", border:"rgba(251,191,36,0.8)", desc:"Notarized document templates",
    templates:[
      {id:"notary-affidavit",    name:"Sworn Affidavit",          desc:"Legal sworn statement with full notary certification.",           preview:"⚖️"},
      {id:"notary-power",        name:"General Power of Attorney", desc:"General or limited power of attorney with scope clauses.",        preview:"🖊️"},
      {id:"notary-declaration",  name:"Statutory Declaration",    desc:"Formal declaration with witness and commissioner blocks.",         preview:"📋"},
      {id:"notary-consent",      name:"Parental Consent Letter",  desc:"Travel, medical or legal consent for minors.",                    preview:"✅"},
      {id:"notary-deed",         name:"Deed of Assignment",       desc:"Transfer of rights, property or intellectual assets.",            preview:"🏠"},
      {id:"notary-undertaking",  name:"Letter of Undertaking",    desc:"Formal binding commitment letter.",                               preview:"📜"},
    ]},
  { id:"rent" as any, label:"Tenancy & Property", icon:"🏠", color:"#f472b6", bg:"rgba(244,114,182,0.22)", border:"rgba(244,114,182,0.8)", desc:"Rental and property documents",
    templates:[
      {id:"rent-tenancy",     name:"Assured Shorthold Tenancy",  desc:"Full AST agreement with all standard UK-compliant terms.",        preview:"🏠"},
      {id:"rent-certificate", name:"Tenancy Confirmation",        desc:"Formal certificate confirming active tenancy status.",            preview:"📜"},
      {id:"rent-receipt",     name:"Rent Payment Receipt",        desc:"Monthly receipt with landlord/tenant details.",                   preview:"🧾"},
      {id:"rent-reference",   name:"Landlord Reference Letter",   desc:"Professional reference confirming good tenancy history.",         preview:"✉️"},
      {id:"rent-notice",      name:"Section 21 Notice to Vacate", desc:"Legally compliant no-fault eviction notice.",                    preview:"📣"},
      {id:"rent-commercial",  name:"Commercial Lease Agreement",  desc:"Business premises full commercial lease with break clauses.",    preview:"🏢"},
    ]},
  { id:"letter" as any, label:"Official Letters", icon:"✉️", color:"#818cf8", bg:"rgba(129,140,248,0.22)", border:"rgba(129,140,248,0.8)", desc:"Authoritative letters for any purpose",
    templates:[
      {id:"letter-general",     name:"General Authority Letter",    desc:"All-purpose formal letter for any government or private body.", preview:"📄"},
      {id:"letter-employment",  name:"Employment Verification",     desc:"HR-signed letter confirming role, salary band and start date.", preview:"💼"},
      {id:"letter-character",   name:"Character Reference",         desc:"Personal reference citing conduct, reliability and character.", preview:"🌟"},
      {id:"letter-bank",        name:"Bank Introduction Letter",    desc:"Formal letter introducing applicant to financial institution.", preview:"🏦"},
      {id:"letter-income",      name:"Proof of Income Letter",      desc:"Certified income confirmation for loans or rental applications.",preview:"💰"},
      {id:"letter-travel",      name:"Travel Authorization",        desc:"Organizational letter authorizing business or official travel.", preview:"✈️"},
    ]},
  { id:"certificate" as any, label:"Certificates", icon:"🎖️", color:"#2dd4bf", bg:"rgba(45,212,191,0.22)", border:"rgba(45,212,191,0.8)", desc:"Achievement and official certificates",
    templates:[
      {id:"cert-completion",    name:"Certificate of Completion",    desc:"Training or course completion with institution details.",        preview:"🎓"},
      {id:"cert-achievement",   name:"Certificate of Achievement",   desc:"Excellence recognition in a specific field.",                   preview:"🏆"},
      {id:"cert-good-conduct",  name:"Certificate of Good Conduct",  desc:"Official clean-conduct statement.",                            preview:"✅"},
      {id:"cert-residence",     name:"Certificate of Residence",     desc:"Address confirmation for official purposes.",                  preview:"🏘️"},
  ...
  { id:"visa" as any, label:"Visa Applications", icon:"🛂", color:"#f87171", bg:"rgba(248,113,113,0.22)", border:"rgba(248,113,113,0.75)", desc:"Official government visa portals with your data pre-filled",
    templates:[
      ...
      {id:"visa-schengen", name:"🇪🇺 Schengen / EU",   desc:"Annex I — Official Schengen Application Form (PDF)",      officialUrl:"https://home-affairs.ec.europa.eu/system/files/2020-02/annex_i_-_application_form_en.pdf", preview:"🇪🇺"},
      {id:"visa-canada",   name:"🇨🇦 Canada",          desc:"IMM 5257B — IRCC Temporary Resident Visa",                officialUrl:"https://www.canada.ca/en/immigration-refugees-citizenship/services/application/application-forms-guides/imm5257.html", preview:"🇨🇦"},
      {id:"visa-uae",      name:"🇦🇪 UAE",             desc:"ICP Unified Visa Portal — icp.gov.ae",                    officialUrl:"https://icp.gov.ae/en/services/",             preview:"🇦🇪"},
      {id:"visa-egypt",    name:"🇪🇬 Egypt",           desc:"Official Egypt e-Visa — visa2egypt.gov.eg",               officialUrl:"https://www.visa2egypt.gov.eg/",              preview:"🇪🇬"},
      {id:"visa-turkey",   name:"🇹🇷 Turkey",          desc:"Official Turkey e-Visa — evisa.gov.tr",                   officialUrl:"https://www.evisa.gov.tr/",                   preview:"🇹🇷"},
      {id:"visa-saudi",    name:"🇸🇦 Saudi Arabia",    desc:"MOFA Visa Portal — visa.mofa.gov.sa",                     officialUrl:"https://visa.mofa.gov.sa/",                   preview:"🇸🇦"},
      {id:"visa-india",    name:"🇮🇳 India",           desc:"e-Visa Portal — indianvisaonline.gov.in",                 officialUrl:"https://indianvisaonline.gov.in/evisa/tvoa.html", preview:"🇮🇳"},
      {id:"visa-china",    name:"🇨🇳 China",           desc:"Visa for China Application — visaforchina.cn",            officialUrl:"https://www.visaforchina.cn/",                preview:"🇨🇳"},
      {id:"visa-malaysia", name:"🇲🇾 Malaysia",        desc:"eVISA Malaysia — windowmalaysia.com.my",                  officialUrl:"https://www.windowmalaysia.com.my/evisa/eVisa.jsp", preview:"🇲🇾"},
      {id:"visa-ethiopia", name:"🇪🇹 Ethiopia",        desc:"Ethiopia e-Visa — evisa.gov.et",                          officialUrl:"https://www.evisa.gov.et/",                   preview:"🇪🇹"},
      {id:"visa-somalia",  name:"🇸🇴 Somalia",         desc:"Somalia Entry Visa — moi.gov.so",                         officialUrl:"https://www.moi.gov.so/",                     preview:"🇸🇴"},
      {id:"visa-kenya",    name:"🇰🇪 Kenya",           desc:"Kenya e-Visa — evisa.go.ke",                              officialUrl:"https://evisa.go.ke/",                        preview:"🇰🇪"},
      {id:"visa-australia",name:"🇦🇺 Australia",       desc:"ImmiAccount — Online Visa Application",                   officialUrl:"https://online.immi.gov.au/lusc/login",       preview:"🇦🇺"},
      {id:"visa-japan",    name:"🇯🇵 Japan",           desc:"MOFA e-Visa Application System",                          officialUrl:"https://www.mofa.go.jp/j_info/visit/visa/",   preview:"🇯🇵"},
      {id:"visa-south-africa", name:"🇿🇦 South Africa",desc:"VFS Global South Africa Visa Portal",                     officialUrl:"https://visa.vfsglobal.com/za/en/",           preview:"🇿🇦"},
      {id:"visa-qatar",    name:"🇶🇦 Qatar",           desc:"Hayya — Official Qatar Visa Portal",                      officialUrl:"https://www.moi.gov.qa/en/services/hayya/",   preview:"🇶🇦"},
    ]},
];
/* ═══════════════════════════════════════ COMPONENT */
          ...
          allRecords.length > 1 ? (
            <select value={record?.id||""} onChange={e=>setRecord(allRecords.find(r=>r.id===e.target.value)||null)}
              style={{fontFamily:"'Orbitron',monospace",fontSize:8,fontWeight:700,letterSpacing:"0.1em",
                ...
                border:"1px solid hsla(192,100%,52%,0.35)",color:"hsl(193,100%,72%)",
