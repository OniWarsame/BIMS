export default function PageFooter() {
  return (
    <div style={{
      ...
      <span style={{fontFamily:"'Outfit',-apple-system,sans-serif",fontSize:12,fontWeight:400,color:"rgba(100,155,225,0.45)",letterSpacing:"0.02em"}}>
        © 2026{" "}
      ...
      <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:"rgba(70,130,215,0.35)",letterSpacing:"0.04em"}}>
        Nexus BIMS v1.0
      </span>
      <span style={{width:3,height:3,borderRadius:"50%",background:"rgba(70,130,255,0.3)",display:"inline-block"}}/>
      <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:"rgba(70,130,215,0.35)",letterSpacing:"0.04em"}}>
