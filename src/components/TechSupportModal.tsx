...
const ISSUES = [
  ...
  { value:"biometric_fail", label:"Biometric Scan Failure",      icon:"🖐️", color:"hsl(270,90%,60%)" },
            ...
            <div className="flex items-center gap-4 px-6 pt-5 pb-4"
              ...
              {showBackButton && (
                <button onClick={()=>{ handleClose(); onBack?.(); }}
                  ...
                  onMouseEnter={e=>e.currentTarget.style.color="hsl(270,90%,72%)"}
              ...
              <motion.div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                ...
                <Headphones size={20} style={{ color:"hsl(270,90%,68%)", filter:"drop-shadow(0 0 8px hsla(192,100%,55%,0.9))" }}/>
              </motion.div>

              <div className="flex-1 min-w-0">
                <h2 style={{ fontFamily:"'Orbitron',monospace", fontSize:15, fontWeight:900,
                  letterSpacing:"0.18em", color:"hsl(270,90%,72%)",
              ...
              <button onClick={handleClose}
                ...
                onMouseEnter={e=>{e.currentTarget.style.background="hsla(192,70%,42%,0.14)";e.currentTarget.style.color="hsl(270,90%,72%)";}}
                ...
                {sent ? (
                  <motion.div key="success"
                    ...
                    <motion.div className="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center"
                      ...
                      <CheckCircle size={30} style={{ color:"hsl(270,90%,68%)", filter:"drop-shadow(0 0 10px hsla(192,100%,55%,0.9))" }}/>
                    </motion.div>
                    <h3 style={{ fontFamily:"'Orbitron',monospace", fontSize:14, fontWeight:800,
                      letterSpacing:"0.2em", color:"hsl(270,90%,72%)", marginBottom:6 }}>
                      TICKET SUBMITTED
                    </h3>
                    ...
                    <button onClick={handleClose}
                      ...
                      style={{ fontFamily:"'Orbitron',monospace", fontSize:10, fontWeight:700, letterSpacing:"0.18em",
                        background:"hsla(192,100%,52%,0.12)", border:"1.5px solid hsla(192,100%,55%,0.55)", color:"hsl(270,90%,72%)" }}
                  ...
                  <motion.div key="form" initial={{ opacity:0 }} animate={{ opacity:1 }} exit={{ opacity:0 }} className="space-y-5">
                    ...
                    <div>
                      ...
                      {allowManualReporter ? (
                        ...
                        <div style={{ ...inputBase, display:"flex", alignItems:"center", gap:10,
                          ...
                          <span style={{ width:7, height:7, borderRadius:"50%", background:"hsl(270,90%,58%)",
                          ...
                          <span style={{ fontFamily:"'Orbitron',monospace", fontSize:11, fontWeight:700,
                            letterSpacing:"0.1em", color:"hsl(270,90%,72%)" }}>
                    ...
                    <button onClick={handleSubmit} disabled={sending}
                      ...
                      style={{ fontFamily:"'Orbitron',monospace", fontSize:10, fontWeight:800, letterSpacing:"0.2em",
                        ...
                        color:"hsl(270,90%,72%)", boxShadow:"0 0 20px hsla(192,100%,52%,0.18)",
